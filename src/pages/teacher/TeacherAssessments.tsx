...
import {
  ...
  Paperclip, FileText, Download, Save, Upload, X, Loader2
} from 'lucide-react'
...
export default function TeacherAssessments() {
  ...
  const stats = {
    ...
    submissions: assessments.reduce((s, a) => s + (a.submissions?.filter(sub => sub.is_submitted).length ?? 0), 0),
  }
    ...
    <div className="ta2-root">
      ...
      <motion.div className="ta2-header" {...stagger(0)}>
        <div>
          ...
          <p className="ta2-sub">Manage, publish, and review all your saved assessments</p>
        </div>
      ...
      {/* Stats */}
      <motion.div className="ta2-stats" {...stagger(1)}>
        {[
      ...
      {/* Filters */}
      <motion.div className="ta2-filters" {...stagger(2)}>
      ...
      {loading ? (
        ...
        <motion.div className="ta2-empty" {...stagger(3)}>
          ...
          <p className="ta2-empty-sub">
            {assessments.length === 0
              ? 'Use the AI generator to create your first assessment.'
              : 'Try a different filter.'}
          </p>
          {assessments.length === 0 && (
            <button className="ta2-generate-btn" onClick={() => navigate('/teacher/assessments/generate')}>
                      ...
                      <div className="ta2-card-actions">
                        ...
                        {confirmDelete === a.id ? (
                          <div className="ta2-confirm-delete">
                            ...
                            <button className="ta2-confirm-no" onClick={() => setConfirmDelete(null)}>No</button>
                          </div>
                        ) : (
